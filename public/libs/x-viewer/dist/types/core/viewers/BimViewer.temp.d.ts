...
import { Viewer3dConfig, CameraConfig, ModelConfig } from "../../core/Configs";
...
import { MeasurementData, MeasurementPlugin, MeasurementType } from "../../plugins/measurements";
...
export declare class Viewer3d extends BaseViewer {
    ...
    private anchor?;
    constructor(viewerCfg: Viewer3dConfig, cameraCfg?: CameraConfig);
    /**
    ...
    setOtherObjectsOpacity(object: THREE.Object3D): void;
